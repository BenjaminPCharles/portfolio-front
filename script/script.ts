const app : {
            ...
            articleDetail?.forEach(article => {
                article.classList.forEach(number => {
                    article1?.forEach(element => {
                            ...
                            if(parseInt(number) === parseInt(element?.id) || parseInt(element?.id) === 6){
                                app.openDetails("1");
                            };
                        });
                    });
                    article2?.forEach(element => {
                            element.addEventListener('click', function handleClick() {
                            if(parseInt(number) === parseInt(element?.id) || parseInt(element?.id) === 7){
                                app.openDetails("2");
                            };
                        });
                    });
                    article3?.forEach(element => {
                            element.addEventListener('click', function handleClick() {
                            if(parseInt(number) === parseInt(element?.id) || parseInt(element?.id) === 8){
                                app.openDetails("3");
                            };
                        });
                    });
                    article4?.forEach(element => {
                            element.addEventListener('click', function handleClick() {
                            if(parseInt(number) === parseInt(element?.id) || parseInt(element?.id) === 9){
                                app.openDetails("4");
                            };
                        });
                    });
                    article5?.forEach(element => {
                            element.addEventListener('click', function handleClick() {
                            if(parseInt(number) === parseInt(element?.id) || parseInt(element?.id) === 10){
                                app.openDetails("5");
                            };
                        });
                    });
    ...
    englishLanguage : function (){
        const menuWho = document.querySelector<HTMLInputElement>(".menu__burger__item--who");
        const menuWhat = document.querySelector<HTMLInputElement>(".menu__burger__item--what");
        const menuHow = document.querySelector<HTMLInputElement>(".menu__burger__item--how");
        const work = document.querySelector<HTMLInputElement>(".dev--web");
        const title = document.querySelector<HTMLInputElement>(".desc__english__title");
        const text = document.querySelector<HTMLInputElement>(".desc__english__text");
        const detailEnglish1 =  document.querySelector<HTMLInputElement>(".detail__english__text_1");
        const detailEnglish2 =  document.querySelector<HTMLInputElement>(".detail__english__text_2");
        const detailEnglish3 =  document.querySelector<HTMLInputElement>(".detail__english__text_3");
        const detailEnglish4 =  document.querySelector<HTMLInputElement>(".detail__english__text_4");
        const detailEnglish5 =  document.querySelector<HTMLInputElement>(".detail__english__text_5");
