var app = {
    clickOnMenuBurger: function () {
        ...
        var burger = document.querySelectorAll(".view__header__menu__burger");
            ...
            article.classList.forEach(function (number) {
                article1 === null || article1 === void 0 ? void 0 : article1.forEach(function (element) {
                    element.addEventListener("click", function handleClick() {
                        if (parseInt(number) === parseInt(element === null || element === void 0 ? void 0 : element.id) ||
                            parseInt(element === null || element === void 0 ? void 0 : element.id) === 6) {
                            app.openDetails("1");
                        }
                    });
                });
                article2 === null || article2 === void 0 ? void 0 : article2.forEach(function (element) {
                    element.addEventListener("click", function handleClick() {
                        if (parseInt(number) === parseInt(element === null || element === void 0 ? void 0 : element.id) ||
                            parseInt(element === null || element === void 0 ? void 0 : element.id) === 7) {
                            app.openDetails("2");
                        }
                    });
                });
                article3 === null || article3 === void 0 ? void 0 : article3.forEach(function (element) {
                    element.addEventListener("click", function handleClick() {
                        if (parseInt(number) === parseInt(element === null || element === void 0 ? void 0 : element.id) ||
                            parseInt(element === null || element === void 0 ? void 0 : element.id) === 8) {
                            app.openDetails("3");
                        }
                    });
                });
                article4 === null || article4 === void 0 ? void 0 : article4.forEach(function (element) {
                    element.addEventListener("click", function handleClick() {
                        if (parseInt(number) === parseInt(element === null || element === void 0 ? void 0 : element.id) ||
                            parseInt(element === null || element === void 0 ? void 0 : element.id) === 9) {
                            app.openDetails("4");
                        }
                    });
                });
                article5 === null || article5 === void 0 ? void 0 : article5.forEach(function (element) {
                    element.addEventListener("click", function handleClick() {
                        if (parseInt(number) === parseInt(element === null || element === void 0 ? void 0 : element.id) ||
                            parseInt(element === null || element === void 0 ? void 0 : element.id) === 10) {
                            app.openDetails("5");
                        }
                    });
                });
